...
const PrivacyPolicy = () => {
    return (
        <article className={style.privacyPolicy}>
            ...
            <p>This website and its contents are subject to copyright under the laws of Bulgaria and, through international treaties, other countries. The copyright in materials on this site and in this website as a whole is owned by Beauty Portal. The copyright in some materials incorporated within this website may be owned by third parties.</p>
