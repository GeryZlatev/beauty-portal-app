...
const Advertising = () => {
    ...
    return (
        <div className={style.advertisingWrapper}>
            ...
            <ul>
                <li> <span><FontAwesomeIcon icon={faArrowSquareRight} /></span>Ellansé ™, winner of Frost & Sullivan 2011 - European Innovative Technology of the Year for dermal fillers!</li>
                ...
                <li>The Ellansé dermal series of fillers is available in four variants: Ellansé ™ - S (1 year), Ellansé ™ - M (2 years), Ellansé ™ - L (3 years) and Ellansé ™ - E (4 years).</li>
            </ul>
