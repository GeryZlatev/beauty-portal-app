...
const Advertising = () => {
    ...
    return (
        <div className={style.advertisingWrapper}>
            ...
            <ul>
                <li> <span className={style.fontAwesone}><FontAwesomeIcon icon={faReact} /></span> Ellansé ™, winner of Frost & Sullivan 2011 - European Innovative Technology of the Year for dermal fillers!</li>
                <li> <span className={style.fontAwesone}><FontAwesomeIcon icon={faReact} /></span> Ellansé ™ is a unique and innovative dermal series of fillers, which introduces a new era of safe and innovative solutions for facial cosmetic procedures.</li>
                <li> <span className={style.fontAwesone}><FontAwesomeIcon icon={faReact} /></span> The Ellansé dermal series of fillers is available in four variants: Ellansé ™ - S (1 year), Ellansé ™ - M (2 years), Ellansé ™ - L (3 years) and Ellansé ™ - E (4 years).</li>
            </ul>
