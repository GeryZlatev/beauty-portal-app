...
const Advertising = () => {
    ...
    return (
        <div className={style.advertisingWrapper}>
            ...
            <ul>
                <li> <span><FontAwesomeIcon icon={faAccessibleIcon} /></span>Ellansé ™, winner of Frost & Sullivan 2011 - European Innovative Technology of the Year for dermal fillers!</li>
