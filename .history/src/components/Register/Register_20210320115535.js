        ...
        return (
            <div className={style["register-wrapper"]}>
                ...
                <form onSubmit={handleSubmit}>
                    <Input type="text" id="email" label="Email" value={email} />
                    <Input type="password" id="password" label="Password" value={password} />
                    <Input type="password" id="repeatPassword" label="Repeat Password" value={repeatPassword} />
