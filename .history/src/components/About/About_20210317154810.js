...
const About = () => {
    return (
        <Fragment>
            ...
            <h2 className={style.aboutHeader}>Our mission</h2>
            ...
            <h2 className={style.aboutHeader}>Beautiful Before. Beautiful After.</h2>
            ...
            <h2 className={style.aboutHeader}>It’s not about not being “enough”.</h2>
