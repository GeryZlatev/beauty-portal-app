...
const About = () => {
    return (
        <Fragment>
            ...
            <p>“The more we talk about all we do the less alone people will feel for not being “born” looking a certain way. It’s all fine. Own getting it own not getting it. It’s all about options and acceptance”<span className={style.author}>— MBD Client</span></p>
        </Fragment>
)
}
