            ...
            <Fragment>
                <footer>
                    ...
                    <div className={style.logo}>
                        <img src={logo} alt="The beauty portal logo"/>
                    </div>
                    <div className={style.portals}>
                        <ul className={style.portalList}>
                            ...
                            <li>
                                <h5><Link to="">Doctor Login</Link></h5>
                            </li>
                            <li>
                                <h5><Link to="">Staff information</Link></h5>
                            </li>
                        </ul>
                        <p className = {style.allRights}> &copy; 2021 All Rights Reserved | <Link href="/privacy-policy"> Privacy Policy</Link> </p>
                    </div>
                </footer>
            </Fragment>
        )
