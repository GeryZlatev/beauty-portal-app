...
const Specialist = (props) => {
    ...
    const [success, setSuccsses] = useState(false);
    ...
    return (
        <div className={style["form-specialist"]}>
            {success ? <Notification>You successfully sent your information! Thank you for applying!</Notification> : <ErrorMessage>Something went wrong! We're so sorry! Please, try again...</ErrorMessage>}
