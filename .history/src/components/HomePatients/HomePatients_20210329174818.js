    ...
    return (
        ...
        <FindServices />
            ...
            <span
                ...
                onClick={() => menuRef.current.className=[style["category-menu"], style.open]}
            >
                &#9776; Favorite Procedures
            </span>
            <div className={style['menu-buttons-wrapper']} ref={menuRef}
                onClick={() => menuRef.current.className=[style["category-menu"], style.close]}>
                <button
                    className={style.closeBtn}
                    onClick={() => menuRef.current.setAttribute('className',[style.closeBtn])}
                >
                    &times; X
                </button>
                    <button
